...
describe Nexus do
  it "computes return value" do
    nexus = Nexus.new nil, "MBI_KEY", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="
  ...
  it "computes return value 2" do
    nexus = Nexus.new nil, "MBI_KEY", "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB="
